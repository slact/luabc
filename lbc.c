/*
* lbc.c
* big-number library for Lua 5.x based on GNU bc-1.06 core library
* Luiz Henrique de Figueiredo <lhf@tecgraf.puc-rio.br>
* 02 Jan 2015 09:39:09
* edited by slact for Lua 5.1-5.3 compatibility
...
#define MYNAME		"bc"
#define MYVERSION	MYNAME " library for " LUA_VERSION " / Dec 2017 / "\
